/**
 * Cars & automotive history — Transport & machines subject package.
 */
...
module.exports = mergeSubjectPackage({
    ...
    meta: {
        ...
        rootSlug: "cars-automotive-history",
        theme: "cars-automotive-history",
        categories: ["transport"],
        copyright: {
            title: "Cars & automotive history is not owned by Ton-o-Lore.",
            body:
    ...
    rawRelationships,
    aliases: {
        "cars-automotive-history": ["Cars & automotive history"]
    },
    parents: {}
});
