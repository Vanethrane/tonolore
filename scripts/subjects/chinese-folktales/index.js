/**
 * Chinese folktales — Folklore & legend subject package.
 */
...
module.exports = mergeSubjectPackage({
    ...
    meta: {
        ...
        rootSlug: "chinese-folktales",
        theme: "chinese-folktales",
        categories: ["folklore"],
        copyright: {
            title: "Chinese folktales is not owned by Ton-o-Lore.",
            body:
    ...
    rawRelationships,
    aliases: {
        "chinese-folktales": ["Chinese folktales"]
    },
    parents: {}
});
