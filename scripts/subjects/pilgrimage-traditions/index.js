/**
 * Pilgrimage traditions — Religion & belief subject package.
 */
...
module.exports = mergeSubjectPackage({
    ...
    meta: {
        ...
        rootSlug: "pilgrimage-traditions",
        theme: "pilgrimage-traditions",
        categories: ["religion"],
        copyright: {
            title: "Pilgrimage traditions is not owned by Ton-o-Lore.",
            body:
    ...
    rawRelationships,
    aliases: {
        "pilgrimage-traditions": ["Pilgrimage traditions"]
    },
    parents: {}
});
