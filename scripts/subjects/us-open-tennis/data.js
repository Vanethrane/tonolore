/**
 * Seed graph for US Open (tennis) (Tennis).
...
const entities = [
    ...
    },
    {
        ...
        description:
            "A working index of the people — players, managers, officials, and icons — that readers meet first when exploring US Open (tennis)."
    },
    {
        ...
        description:
            "Team and club identities that structure seasons, rivalries, and fan lore around US Open (tennis)."
    },
    {
        ...
        description:
            "Places where US Open (tennis) is contested — home grounds, finals sites, and landmark venues in the sport's memory."
    },
    {
        ...
        description:
            "Championships, eras, and signature events that periodize how fans and writers talk about US Open (tennis)."
    },
    {
        ...
        description:
            "The structural ideas — schedules, standings, playoffs, and rulebooks — that make US Open (tennis) legible as a sport."
    }
];
